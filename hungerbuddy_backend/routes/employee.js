...
router.post(
  ...
  function (req, res, next) {
    try {
      ...
      pool.query(
        "insert into employee(branchid,employeename, dob, gender, emailid, mobileno,otherno,department, current_address, current_state, current_city, current_pincode, permanent_address, permanent_state, permanent_city, permanent_pincode, employee_picture, createdtime, createddate, userid)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
        [
          req.body.branchid,
