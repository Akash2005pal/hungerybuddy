...
router.post(
  ...
  function (req, res, next) {
    try {
      ...
      pool.query(
        "insert into students(enrollmentno, branchid, batchid, sectionid, studentname, dob, gender, fathername, mothername, emailid, mobileno, addharno, fathercontactno, mothercontactno, current_address, current_state, current_city, current_pincode, permanent_address, permanent_state, permanent_city, permanent_pincode, student_picture, createdtime, createddate, userid)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
        [
...
router.post(
  ...
  function (req, res, next) {
    try {
      pool.query(
        "update students set student_picture=?,createddate=?,createdtime=?,userid=? where enrollmentno=?",
        [
          req.file.filename,
          req.body.createddate,
          req.body.createdtime,
